...
import { Mail, Lock, User, ArrowRight, ArrowLeft, CheckCircle, Shield, X, Smartphone, QrCode, CheckCircle2, Copy, Apple } from 'lucide-react';
import {
  BrandedContainer,
  BrandedCard,
  BrandedInput,
...
export default function BrandedPublicAuth({
  ...
  useEffect(() => {
    ...
    const faviconUrl = branding.favicon_url || AUTHSYSTEM_DEFAULT_FAVICON;
    ...
    try {
      ...
      if (errorCode === 'MFA_SETUP_REQUIRED') {
        ...
        try {
          ...
          setMfaSetupLinked(false);
          setMfaAutoStartingSession(false);
          setMfaSetupData(fallbackSetupData || null);
          shouldNotifyError = false;

          const pairingToken = fallbackSetupData?.pairing_token;
          if (pairingToken) {
            startMfaSetupPolling(pairingToken);
          }
          return;
